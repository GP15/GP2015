...
class PartnersControllerTest < ActionController::TestCase
  ...
  test "should create partner" do
    assert_difference('Partner.count') do
      post :create, partner: { address: @partner.address, city_id: @partner.city_id, company: @partner.company, phone: @partner.phone, state: @partner.state }
    end
  ...
  test "should update partner" do
    patch :update, id: @partner, partner: { address: @partner.address, city_id: @partner.city_id, company: @partner.company, phone: @partner.phone, state: @partner.state }
    assert_redirected_to partner_path(assigns(:partner))
  end
